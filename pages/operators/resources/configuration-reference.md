...
This page provides a reference for configuring the XRPL EVM sidechain nodes using the configuration files `config.toml`, `app.toml`, and `client.toml`. Each configuration key is described in detail.
